                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button type="button" class="btn-action btn-detail" title="Detail" 
                                                onclick="openViewDetailStaffPopup(
...
<div id="viewDetailStaffPopup" class="modal-overlay" style="display: none;">
    <div class="modal-content">
        ...
        <div style="text-align: center; margin-bottom: 20px; margin-top: 10px;">
            <img id="detailStaffAvatar" src="${pageContext.request.contextPath}/assets/images/default-avt.jpg" 
        ...
        <div class="modal-footer" style="margin-top: 20px;">
            <button type="button" class="btn-cancel" onclick="closeViewDetailStaffPopup()">Close</button>
        </div>
    </div>
</div>
